...
export default z.object({
  ...
  ).describe('Items to be displayed in the toolbar').default([]),
  'isReorderDisabled': z.boolean().describe('Whether the reordering possible on the toolbar').default(false),
  'left': z.array(
    z.union([
      z.string().describe(
        'Visual id composed of the creator username and the resource name. e.g. `@username/resource-name`',
